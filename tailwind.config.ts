...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'lavender': '0 10px 30px -10px hsl(var(--primary) / 0.3)',
				'glow': '0 0 40px hsl(var(--primary-glow) / 0.4)',
				'card': '0 4px 20px hsl(var(--primary) / 0.1)'
			},
			backgroundImage: {
				'gradient-primary': 'linear-gradient(135deg, hsl(var(--primary)), hsl(var(--primary-glow)))',
				'gradient-soft': 'linear-gradient(180deg, hsl(var(--background)), hsl(var(--secondary)))',
